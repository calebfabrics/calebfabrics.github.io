const phoneNumber = "+2348027155994";  // Change this to the target phone number
        const message = "I want to pay for this product.";
        const pageURL = window.location.href; // Get the current page URL

        // Encode message to be URL-safe
        const encodedMessage = encodeURIComponent(`${message} Here is the product link: ${pageURL}`);

        // Set the WhatsApp link dynamically
        document.getElementById("whatsapp-link").href = `https://wa.me/${phoneNumber}?text=${encodedMessage}`;
